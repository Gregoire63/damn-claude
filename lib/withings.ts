// Décodage des mesures Withings et statistiques corporelles.
// Pur : aucun appel réseau, aucun DOM. Les échanges HTTP vivent dans server/api/withings/,
// parce que le client_secret n'a rien à faire dans un navigateur.
//
// Dans lib/ et non utils/ : Nuxt auto-importe tout utils/, et ces symboles n'ont aucune
// raison d'atterrir dans l'espace de noms global de l'application.
