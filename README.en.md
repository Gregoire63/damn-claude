...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1292-3f7a4f" alt="1292 tests">
...
| `npm test` | 1292 tests, 76 files, two Vitest projects |
...
composables/             state, persisted in localStorage (31 files, no Pinia)
lib/                     pure logic — no DOM, no storage, tested (24 files)
