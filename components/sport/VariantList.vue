 ...
 *
 * Cette liste répond aux deux questions qu'on se pose vraiment devant la machine
 ...
 *
 * Elle a été une FENÊTRE à elle, ouverte depuis la carte de l'exercice. Elle se
 * déplie maintenant DANS le menu du mouvement : choisir sa machine, écrire un
 * commentaire et relire les consignes sont trois moments du même geste — « ça ne se
 * passe pas comme prévu » — et les répartir sur trois calques obligeait à ressortir
 * de l'un pour entrer dans l'autre.
 */
